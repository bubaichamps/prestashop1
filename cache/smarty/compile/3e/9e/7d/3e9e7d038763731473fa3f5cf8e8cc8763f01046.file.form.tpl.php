<?php /* Smarty version Smarty-3.1.19, created on 2016-02-13 13:44:49
         compiled from "C:\xampp\htdocs\prestashop1\modules\blocktopmenu\views\templates\admin\_configure\helpers\form\form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:937056bee5f976b164-11881703%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3e9e7d038763731473fa3f5cf8e8cc8763f01046' => 
    array (
      0 => 'C:\\xampp\\htdocs\\prestashop1\\modules\\blocktopmenu\\views\\templates\\admin\\_configure\\helpers\\form\\form.tpl',
      1 => 1452079228,
      2 => 'file',
    ),
    'a90226c78d43246ea6fb8b2db77421cd9c3f03ea' => 
    array (
      0 => 'C:\\xampp\\htdocs\\prestashop1\\admin120uo4kbc\\themes\\default\\template\\helpers\\form\\form.tpl',
      1 => 1452079228,
      2 => 'file',
    ),
    '522c075d3b5afcd06ebba19c7a87301a399c12f6' => 
    array (
      0 => 'C:\\xampp\\htdocs\\prestashop1\\admin120uo4kbc\\themes\\default\\template\\helpers\\form\\form_group.tpl',
      1 => 1452079228,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '937056bee5f976b164-11881703',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_56bee5faa70ca2_52774072',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_56bee5faa70ca2_52774072')) {function content_56bee5faa70ca2_52774072($_smarty_tpl) {?><?php if (!is_callable('smarty_function_counter')) include 'C:\\xampp\\htdocs\\prestashop1\\tools\\smarty\\plugins\\function.counter.php';
?>
...
<?php } else { ?>9<?php }?><?php if (!isset($_smarty_tpl->tpl_vars['input']->value['label'])) {?> col-lg-offset-3<?php }?>">
    ...
    <?php if ($_smarty_tpl->tpl_vars['input']->value['type']=='link_choice') {?>
	    <div class="row">
	    	<div class="col-lg-1">
	    		<h4 style="margin-top:5px;"><?php echo smartyTranslate(array('s'=>'Change position','mod'=>'blocktopmenu'),$_smarty_tpl);?>
</h4> 
	    	...
	    	<div class="col-lg-4">
	    		<h4 style="margin-top:5px;"><?php echo smartyTranslate(array('s'=>'Selected items','mod'=>'blocktopmenu'),$_smarty_tpl);?>
</h4>
	    		<?php echo $_smarty_tpl->tpl_vars['selected_links']->value;?>

	    	</div>
	    	<div class="col-lg-4">
	    		<h4 style="margin-top:5px;"><?php echo smartyTranslate(array('s'=>'Available items','mod'=>'blocktopmenu'),$_smarty_tpl);?>
</h4>
	    ...
	    <div class="row">
	    	...
	    	<div class="col-lg-4"><a href="#" id="removeItem" class="btn btn-default"><i class="icon-arrow-right"></i> <?php echo smartyTranslate(array('s'=>'Remove','mod'=>'blocktopmenu'),$_smarty_tpl);?>
</a></div>
	    	<div class="col-lg-4"><a href="#" id="addItem" class="btn btn-default"><i class="icon-arrow-left"></i> <?php echo smartyTranslate(array('s'=>'Add','mod'=>'blocktopmenu'),$_smarty_tpl);?>
</a></div>
	    </div>
	<?php } else { ?>
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('helpers/form/form_group.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '937056bee5f976b164-11881703');
content_56bee5fa6697b0_75925179($_smarty_tpl);
...
function add()
{
	$("#availableItems option:selected").each(function(i){
		...
		if (val == "PRODUCT")
		{
			val = prompt('<?php echo smartyTranslate(array('s'=>"Indicate the ID number for the product",'mod'=>'blocktopmenu','js'=>1),$_smarty_tpl);?>
');
			if (val == null || val == "" || isNaN(val))
				return;
			text = '<?php echo smartyTranslate(array('s'=>"Product ID #",'mod'=>'blocktopmenu','js'=>1),$_smarty_tpl);?>
'+val;
			val = "PRD"+val;
		}
...
function move(up)
{
        ...
        if (tomove.length >1)
        {
                alert('<?php echo smartyTranslate(array('s'=>"Please select just one item",'mod'=>'blocktopmenu'),$_smarty_tpl);?>
');
                return false;
        }
        if (up)
...
<?php }?>
<?php }} ?>
<?php /* Smarty version Smarty-3.1.19, created on 2016-02-13 13:44:50
         compiled from "C:\xampp\htdocs\prestashop1\admin120uo4kbc\themes\default\template\helpers\form\form_group.tpl" */ ?>
<?php if ($_valid && !is_callable('content_56bee5fa6697b0_75925179')) {function content_56bee5fa6697b0_75925179($_smarty_tpl) {?>
